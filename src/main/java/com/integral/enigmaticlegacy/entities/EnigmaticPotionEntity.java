...
/**
 * Modified version of Potion Entity designed specifically for Enigmatic Legacy's potions.
 * @author Integral
 */
            ...
            if (livingentity.canBeHitWithPotion()) {
               ...
               if (d0 < 16.0D) {
                  ...
                  for(EffectInstance effectinstance : p_213888_1_) {
                     ...
                     if (effect.isInstant()) {
                        effect.affectEntity(this, (LivingEntity)this.func_234616_v_(), livingentity, effectinstance.getAmplifier(), d1);
                     } else {
