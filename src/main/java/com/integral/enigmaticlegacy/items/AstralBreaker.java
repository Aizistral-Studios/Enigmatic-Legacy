...
public class AstralBreaker extends ToolItem implements IPerhaps {
 ...
 public AstralBreaker(IItemTier tier, Function<Properties, Properties> properties) {
		...
		effectiveMaterials.addAll(((EtheriumPickaxe)EnigmaticLegacy.etheriumPickaxe).effectiveMaterials);
		effectiveMaterials.addAll(((EtheriumAxe)EnigmaticLegacy.etheriumAxe).effectiveMaterials);
		effectiveMaterials.addAll(((EtheriumShovel)EnigmaticLegacy.etheriumShovel).effectiveMaterials);
	}
